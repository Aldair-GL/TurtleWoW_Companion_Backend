...
(15, 'Mulgore', 'Mulgore is a vast, beautiful grassland in central Kalimdor and the ancestral homeland of the Tauren people. Rolling green hills, wildflowers, and roaming herds of kodo beasts create one of the most serene landscapes in World of Warcraft. New Tauren characters begin at Camp Narache in Red Cloud Mesa, fighting aggressive swoops, bristleback quilboar, and learning the ways of the Earth Mother. The zone''s main quest hub is Bloodhoof Village, named after the ruling Bloodhoof tribe led by the wise Cairne. Mulgore is ringed by mountains that protect it from the outside world, with Thunder Bluff â€” the tauren capital built atop towering mesas â€” rising dramatically in the center. Despite its peaceful appearance, threats from the Venture Company, hostile quilboar, and wayward harpies keep adventurers busy.', 1, 10, 'KALIMDOR', 'OPEN_WORLD', 2, NULL),
...
(43, 'Dustwallow Marsh', 'Dustwallow Marsh is a humid, swampy region on the eastern coast of Kalimdor, notable for containing Theramore Isle â€” the Alliance''s major stronghold in Kalimdor, founded and led by the sorceress Jaina Proudmoore. The marsh is filled with hostile creatures: black dragonkin, swamp creatures, murlocs, and hostile ogres. Brackenwall Village serves as the Horde quest hub. Key storylines involve investigating the mysterious burning of a Horde village, dealing with the black dragonflight presence in Onyxia''s Lair (accessible from this zone), and the political tensions between Theramore and the Horde. The zone contains the entrance to Onyxia''s Lair, one of the first raid encounters available to level 60 players.', 35, 45, 'KALIMDOR', 'OPEN_WORLD', 1, NULL),
(44, 'Hillsbrad Foothills', 'Hillsbrad Foothills is a fertile farming region in the northern Eastern Kingdoms, famous in WoW history as one of the most intense world PvP zones. The conflict between the Alliance town of Southshore and the Horde outpost of Tarren Mill has become legendary, with spontaneous large-scale battles erupting regularly on PvP servers. The zone features rolling green hills, farms, and the Alterac Mountains looming to the north. Quest content involves the Forsaken''s efforts to develop the New Plague at the Sludge Fields, the defense of Southshore against Syndicate rogues and undead incursions, and the conflict over Durnholde Keep â€” the former internment camp where Thrall was raised as a slave. The zone offers a compelling blend of lore and PvP excitement.', 20, 30, 'EASTERN_KINGDOMS', 'OPEN_WORLD', NULL, NULL),
(45, 'Alterac Mountains', 'Alterac Mountains is a snowy, mountainous zone in the northern Eastern Kingdoms, home to the ruins of the fallen Kingdom of Alterac â€” a human nation that betrayed the Alliance during the Second War. The zone features hostile Syndicate operatives (remnants of the Alterac nobility turned crime lords), yeti, ogres, and mountain lions. Key locations include the Alterac Ruins, Strahnbrad (an abandoned town), and Chillwind Point which connects to the Western Plaguelands. The zone also serves as the setting for the Alterac Valley battleground â€” an epic 40-versus-40 PvP battle that can last for hours as players fight for territory, summon powerful NPCs, and attempt to defeat the enemy faction''s general.', 30, 40, 'EASTERN_KINGDOMS', 'OPEN_WORLD', NULL, NULL)
ON CONFLICT (id) DO NOTHING;

-- ==================== MAZMORRAS ====================
INSERT INTO zones (id, name, description, min_level, max_level, continent, zone_type, faction_id, image_url) VALUES
(50, 'Ragefire Chasm', 'Ragefire Chasm is the first dungeon available to Horde players, located beneath the city of Orgrimmar itself. The volcanic caverns are infested by Burning Blade cultists â€” orcs who secretly serve the Burning Legion â€” along with their summoned demons and fire elementals. Thrall has ordered the cultists eliminated before they can threaten the capital from within. The dungeon is short and straightforward, making it ideal for new players learning group dynamics. Four bosses await: Oggleflint, Taragaman the Hungerer, Jergosh the Invoker, and Bazzalan.', 13, 18, 'KALIMDOR', 'DUNGEON', 2, NULL),
...
(57, 'Scarlet Monastery', 'Scarlet Monastery is a four-wing dungeon complex in Tirisfal Glades, serving as the headquarters of the fanatical Scarlet Crusade â€” humans who are so obsessed with purging the undead that they attack anyone they suspect of corruption. The wings are the Graveyard (lowest level), Library, Armory, and Cathedral, each with distinct bosses and loot tables. The Monastery houses some of the most iconic encounters in Vanilla WoW, from Herod''s devastating Whirlwind in the Armory to the dramatic Mograine-Whitemane resurrection event in the Cathedral. The dungeon is equally popular with both factions and features some of the best leveling gear in the game.', 26, 45, 'EASTERN_KINGDOMS', 'DUNGEON', NULL, NULL),
(58, 'Razorfen Kraul', 'Razorfen Kraul is the thorny, labyrinthine lair of the Razorfen quilboar tribe, located in the southern Barrens. The quilboar â€” pig-like humanoids â€” have built their settlement within a massive network of thorny vines that grew from the blood of the demigod Agamaggan. The dungeon features winding thorn-covered passages, quilboar shaman and warriors, and culminates in a confrontation with the matriarch Charlga Razorflank. The dungeon offers a unique aesthetic with its organic thorn architecture and includes quests involving stopping the quilboar expansion.', 30, 40, 'KALIMDOR', 'DUNGEON', NULL, NULL),
...
(60, 'Uldaman', 'Uldaman is an ancient Titan research facility hidden beneath the Badlands, where dwarves excavating for archaeological treasures have accidentally awakened its stone guardians. The dungeon is a treasure trove of Titan lore, featuring massive stone halls, trogg-infested caverns, and Dark Iron dwarf excavation teams. The climactic encounter with Archaedas â€” a colossal Titan stone guardian â€” involves waves of awakening stone constructs. The dungeon also contains the Discs of Norgannon, which reveal secrets about the origins of the dwarven race and their connection to the Titans. Uldaman is essential for understanding WoW''s deeper lore.', 42, 52, 'EASTERN_KINGDOMS', 'DUNGEON', NULL, NULL),
(61, 'Zul''Farrak', 'Zul''Farrak is an ancient troll city in the Tanaris desert, home to the hostile Sandfury trolls who guard their sacred treasures with fanatical devotion. The dungeon is set entirely outdoors in a sun-baked temple complex and features one of the most beloved encounters in Vanilla WoW â€” the Stairs Event, where players must defend a group of rescued prisoners atop a ziggurat against waves of troll attackers. Other notable encounters include Antu''sul and his basilisks, the sacred pool of Gahz''rilla (a hydra boss summoned with a special mallet), and Chief Ukorz Sandscalp. The zone''s open-air design makes it unique among WoW dungeons.', 44, 54, 'KALIMDOR', 'DUNGEON', NULL, NULL),
(62, 'Maraudon', 'Maraudon is a sacred cave in Desolace, corrupted by the elemental Princess Theradras â€” daughter of Therazane the Stonemother. According to legend, the demigod Zaetar, son of Cenarius, fell in love with Theradras, and their union produced the centaur race. When the centaur killed Zaetar, Theradras kept his spirit imprisoned in the depths of the cave. The dungeon features two distinct entrance paths (orange and purple crystals) that converge on the inner sanctum. The environment transitions from corrupted caverns to a stunning underground paradise where Theradras resides. Notable loot includes the Blade of Eternal Darkness.', 46, 55, 'KALIMDOR', 'DUNGEON', NULL, NULL),
...
-- ====================================================================
-- BOTIN (LOOT) â€” Items iconicos por boss
-- ====================================================================
...
-- ====================================================================
-- ITEMS GENERALES (tabla items â€” independiente de loot_items)
